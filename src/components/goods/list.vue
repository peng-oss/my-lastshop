...
<el-card>
  <el-row :gutter='20'>
    <el-col :span="8"> 
 <el-input placeholder="请输入内容" v-model="querinfo.query" clearable @clear="getGoodlists">
   ...
   <el-table-column label="创建时间" prop="add_time" width="140px">
    ...
    <el-table-column label="操作" width="130px">
     <template #default="one">
        ...
        size="mini" @click="removebyID(one.row.goods_id)"></el-button>
     </template>
